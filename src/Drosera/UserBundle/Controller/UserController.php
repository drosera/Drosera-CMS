...
class UserController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                $this->get('session')->setFlash('success', 'Uživatel byl úspìšnì vytvoøen!');  
    ...
    public function editAction(Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                $userManager->update($user); 
                $this->get('session')->setFlash('success', 'Uživatel byl úspìšnì upraven!');  
                return $this->redirect($this->generateUrl('drosera_user_admin_user_list'));
            }
        }
    ...
    public function restoreAction($id)
    {
        ...
        $this->get('session')->setFlash('success', 'Uživatel byl úspìšnì obnoven!');
        return $this->redirect($this->generateUrl('drosera_user_admin_user_trash'));
    }
    ...
    public function removeAction($id)
    {
        ...
        $this->get('session')->setFlash('success', 'Uživatel byl pøesunut do koše!');       
        return $this->redirect($this->generateUrl('drosera_user_admin_user_list'));
    }
    ...
    public function deleteAction($id)
    {
        ...
        $this->get('session')->setFlash('success', 'Uživatel byl úspìšnì odstranìn!');       
        return $this->redirect($this->generateUrl('drosera_user_admin_user_trash'));
    }
